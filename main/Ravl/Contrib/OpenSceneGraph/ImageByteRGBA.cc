...
namespace RavlOSGN
{
  ...
  bool ImageByteRGBAC::AlphaImageEnable(bool alphaImageEnable)
  {
    if (!m_node)
      return false;
  ...
  bool ImageByteRGBAC::SetAlpha(float alpha)
  {
  ...
  bool ImageByteRGBAC::UpdateAlphaRenderState(ref_ptr<StateSet> &stateSetRef)
  {
