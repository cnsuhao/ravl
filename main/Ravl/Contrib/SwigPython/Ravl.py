...
class DListRealConstIterC(DListRealIterC):
    """Proxy of C++ DListRealConstIterC class"""
    __swig_setmethods__ = {}
...
class DListIntConstIterC(DListIntIterC):
    """Proxy of C++ DListIntConstIterC class"""
    __swig_setmethods__ = {}
...
class DListUIntConstIterC(DListUIntIterC):
    """Proxy of C++ DListUIntConstIterC class"""
    __swig_setmethods__ = {}
...
class DListInt64ConstIterC(DListInt64IterC):
    """Proxy of C++ DListInt64ConstIterC class"""
    __swig_setmethods__ = {}
...
class DListInt16ConstIterC(DListInt16IterC):
    """Proxy of C++ DListInt16ConstIterC class"""
    __swig_setmethods__ = {}
...
class DListByteConstIterC(DListByteIterC):
    """Proxy of C++ DListByteConstIterC class"""
    __swig_setmethods__ = {}
...
class IndexRange2dC(_object):
    ...
    def TRow(*args):
        """TRow(self) -> IndexC"""
        return _Ravl.IndexRange2dC_TRow(*args)

    def BRow(*args):
        """BRow(self) -> IndexC"""
        return _Ravl.IndexRange2dC_BRow(*args)

    def LCol(*args):
        """LCol(self) -> IndexC"""
        return _Ravl.IndexRange2dC_LCol(*args)

    def RCol(*args):
        """RCol(self) -> IndexC"""
        return _Ravl.IndexRange2dC_RCol(*args)

    def TopLeft(*args):
        """TopLeft(self) -> Index2dC"""
        return _Ravl.IndexRange2dC_TopLeft(*args)

    def TopRight(*args):
        """TopRight(self) -> Index2dC"""
        return _Ravl.IndexRange2dC_TopRight(*args)

    def BottomLeft(*args):
        """BottomLeft(self) -> Index2dC"""
        return _Ravl.IndexRange2dC_BottomLeft(*args)

    def BottomRight(*args):
        """BottomRight(self) -> Index2dC"""
        return _Ravl.IndexRange2dC_BottomRight(*args)

    def Center(*args):
        """Center(self) -> Index2dC"""
        return _Ravl.IndexRange2dC_Center(*args)
...
class ImageByteC(Array2dByteC):
    ...
    def Stride(*args):
        """Stride(self) -> IntT"""
        return _Ravl.ImageByteC_Stride(*args)
    ...
    def DataAsStringTriple(*args):
        """DataAsStringTriple(self) -> PyObject"""
        return _Ravl.ImageByteC_DataAsStringTriple(*args)
