...
namespace RavlN {
  ...
  ClassifierPreprocessBodyC::ClassifierPreprocessBodyC(istream &strm)
    : ClassifierBodyC(strm)
  { 
    IntT version;
    strm >> version;
    if(version != 0)
      throw ExceptionOutOfRangeC("ClassifierPreprocessBodyC::ClassifierPreprocessBodyC(istream &), Unrecognised version number in stream. ");
    ...
    : ClassifierBodyC(strm)
  {
    ...
    strm >> version;
    if(version != 0)
      throw ExceptionOutOfRangeC("ClassifierPreprocessBodyC::ClassifierPreprocessBodyC(BinIStreamC &), Unrecognised version number in stream. ");
    strm >> func >> classifier; 
  }
  
  //: Writes object to stream, can be loaded using constructor
  
  bool ClassifierPreprocessBodyC::Save(ostream &out) const {
