...
namespace RavlN {
  ...
  DesignClassifierNeuralNetworkBodyC::DesignClassifierNeuralNetworkBodyC(UIntT nLayers, UIntT nInputs, UIntT nHidden,
                                                                         UIntT nOutputs)
  ...
  DesignClassifierNeuralNetworkBodyC::DesignClassifierNeuralNetworkBodyC(istream &strm)
    ...
    if (version != 0)
      throw ExceptionOutOfRangeC(
          "DesignClassifierNeuralNetworkBodyC::DesignClassifierNeuralNetworkBodyC(istream &), Unrecognised version number in stream. ");
    strm >> m_nLayers;
    strm >> m_nInputs;
    strm >> m_nHidden;
    strm >> m_nOutputs;
...
//: Load from binary stream.
  ...
  DesignClassifierNeuralNetworkBodyC::DesignClassifierNeuralNetworkBodyC(BinIStreamC &strm)
    ...
    if (version != 0)
      throw ExceptionOutOfRangeC(
          "DesignClassifierNeuralNetworkBodyC::DesignClassifierNeuralNetworkBodyC(BinIStreamC &), Unrecognised version number in stream. ");
    strm >> m_nLayers;
    strm >> m_nInputs;
    strm >> m_nHidden;
    strm >> m_nOutputs;
...
//////////////////////////////////////////////////////////
  ...
  RAVL_INITVIRTUALCONSTRUCTOR_FULL(DesignClassifierNeuralNetworkBodyC, DesignClassifierNeuralNetworkC,
      DesignClassifierSupervisedC);

  RavlN::XMLFactoryRegisterHandleConvertC<DesignClassifierNeuralNetworkC, DesignClassifierSupervisedC> g_registerXMLFactoryDesignClassifierNeuralNetwork(
      "RavlN::DesignClassifierNeuralNetworkC");
