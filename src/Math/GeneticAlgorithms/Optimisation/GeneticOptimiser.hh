...
namespace RavlN { namespace GeneticN {
  ...
  protected:
    ...
    float m_mutationRate;  //!< Fraction of new population to mutate.
    ...
    float m_mutationDegree;//!< When an genome is selected for mutation, this controls what the chance of changing any single item is.
    UIntT m_populationSize;//!< Number of genomes in the total population
    UIntT m_numGenerations;//!< Limit on the number of generations to preform.
