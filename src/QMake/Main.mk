...
TESTBINLIBS += -L$(INST_LIB) -L$(BASE_INSTALL)/lib/RAVL/$(ARC)/$(BASE_VAR)$(SHARED_LIB_POSTFIX) $(LINKTESTLIBS)
BINLIBS += -L$(INST_LIB) -L$(BASE_INSTALL)/lib/RAVL/$(ARC)/$(BASE_VAR)$(SHARED_LIB_POSTFIX) $(LINKLIBS)
LIBS += -L$(INST_LIB) -L$(BASE_INSTALL)/lib/RAVL/$(ARC)/$(BASE_VAR)$(SHARED_LIB_POSTFIX) $(EXELIB)
