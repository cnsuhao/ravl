...
class VectorC(TVectorReal):
    ...
    def AsNumPy(self):
        ...
        return _Ravl.VectorC_AsNumPy(self)
...
class MatrixC(TMatrixReal):
    ...
    def AsNumPy(self):
        """AsNumPy(self) -> PyObject"""
        return _Ravl.MatrixC_AsNumPy(self)
...
class RealHistogram1dC(SArray1dReal):
    ...
    def SmoothedPDF(self, *args):
        """
        SmoothedPDF(self, bin, sigma = 1) -> RealT
        SmoothedPDF(self, bin) -> RealT
        """
...
class SampleVectorC(SampleOfVectorC):
    ...
    def AsNumPy(self):
        """AsNumPy(self) -> PyObject"""
        return _Ravl.SampleVectorC_AsNumPy(self)
...
class SampleLabelC(SampleOfUInt):
    ...
    def AsNumPy(self):
        """AsNumPy(self) -> PyObject"""
        return _Ravl.SampleLabelC_AsNumPy(self)
...
def CreateDataSet(dimension = 2, classes = 2, samplesPerClass = 1000, 
    dist = 3.0):
  """
    CreateDataSet(dimension = 2, classes = 2, samplesPerClass = 1000, 
        dist = 3.0) -> DataSetVectorLabelC
...
class LinearKernelC(KernelFunctionC):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(self, scale) -> LinearKernelC"""
...
class QuadraticKernelC(KernelFunctionC):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(self, scale) -> QuadraticKernelC"""
...
class PolynomialKernelC(KernelFunctionC):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(self, power, scale, B) -> PolynomialKernelC"""
        this = _Ravl.new_PolynomialKernelC(*args)
        try: self.this.append(this)
        except: self.this = this
...
class RBFKernelC(KernelFunctionC):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(self, gamma) -> RBFKernelC"""
...
class Chi2KernelC(KernelFunctionC):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """__init__(self, gamma) -> Chi2KernelC"""
...
class DesignSvmSmoC(DesignSvmC):
    ...
    def __init__(self, *args): 
        """
        __init__(self, KernelFunction, Penalty1 = 1000, Penalty2 = 1000, Tolerance = 0.0000001, 
            Eps = 0.000000001, LambdaThreshold = 0.000000000001) -> DesignSvmSmoC
        __init__(self, KernelFunction, Penalty1 = 1000, Penalty2 = 1000, Tolerance = 0.0000001, 
            Eps = 0.000000001) -> DesignSvmSmoC
        __init__(self, KernelFunction, Penalty1 = 1000, Penalty2 = 1000, Tolerance = 0.0000001) -> DesignSvmSmoC
        __init__(self, KernelFunction, Penalty1 = 1000, Penalty2 = 1000) -> DesignSvmSmoC
        __init__(self, KernelFunction, Penalty1 = 1000) -> DesignSvmSmoC
        __init__(self, KernelFunction) -> DesignSvmSmoC
        """
...
class ErrorBinaryClassifierC(ErrorC):
    ...
    def FalseRejectRate(self, *args):
        """FalseRejectRate(self, classifier, dset, falseAcceptRate) -> RealT"""
        return _Ravl.ErrorBinaryClassifierC_FalseRejectRate(self, *args)

    def FalseAcceptRate(self, *args):
        """FalseAcceptRate(self, classifier, dset, falseRejectRate) -> RealT"""
