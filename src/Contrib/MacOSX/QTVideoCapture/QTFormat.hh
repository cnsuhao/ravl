...
#ifndef RAVLIMAGE_QTFORMAT_HEADER
#define RAVLIMAGE_QTFORMAT_HEADER 1
////////////////////////////////////////////////////////////////
...
namespace RavlImageN
{
  /////////////////////////////
  //! userlevel = Develop
  //: QT file format information.
  
  class FileFormatQTBodyC :
  ...
  /////////////////////////////
  //! userlevel = Advanced
  //: Create an instance of a QT file format.
  // BIG OBJECT
  ...
  public:
    FileFormatQTC() :
      FileFormatC<ImageC<ByteRGBValueC> >(*new FileFormatQTBodyC())
    {}
  };
