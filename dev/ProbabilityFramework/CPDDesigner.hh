...
namespace RavlProbN {
  ...
  public:
    ...
    virtual ConditionalProbabilityDistributionC CreateCPD(const DListC<Tuple2C<RandomVariableValueC,PropositionC> >& propositionPairs) const=0;
  ...
  public:
    ...
    ConditionalProbabilityDistributionC CreateCPD(const DListC<Tuple2C<RandomVariableValueC,PropositionC> >& propositionPairs) const
