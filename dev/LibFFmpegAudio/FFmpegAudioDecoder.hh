...
namespace RavlN {
  ...
  public:
    ...
    bool GetFrame(SArray1dC<SampleElemC<2,Int16T> > &frame);
  ...
  public:
    ...
    virtual bool Get(SArray1dC<SampleElemC<2,Int16T> > &buff)
    { return GetFrame(buff); }
    //: Get next image.

    virtual SArray1dC<SampleElemC<2,Int16T> > Get() { 
      SArray1dC<SampleElemC<2,Int16T> > buff;
      if(!GetFrame(buff))
