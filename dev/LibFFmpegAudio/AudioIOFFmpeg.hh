...
namespace RavlAudioN
{
  ...
  : public DPIStreamOpBodyC< SampleElemC<2,Int16T> , SArray1dC<SampleElemC<2,Int16T> > >,
  ...
  public:
    ...
    virtual SArray1dC<SampleElemC<2,Int16T> > Get()
    {
     SArray1dC<SampleElemC<2,Int16T> > img;
      if (!Get(img))
    ...
    virtual bool Get(SArray1dC<SampleElemC<2,Int16T> > &img);
    //: Get next frame.
  ...
  private:
    CacheC<StreamPosT,Tuple2C<SArray1dC<SampleElemC<2,Int16T> >,IntT> > m_imageCache;   // Frame cache
  };

  
  
  class AudioILibFFmpegC :
      public DPIStreamOpC< Int16T, SArray1dC<SampleElemC<2,Int16T> > >,
    public DPSeekCtrlC
  {
  public:
    AudioILibFFmpegC() :
    ...
    SArray1dC<SampleElemC<2,Int16T> > Get() 
    { return Body().Get(); }
    //: Get next frame. 
    //!cwiz:author
    
    bool Get(SArray1dC<SampleElemC<2,Int16T> > & img) 
    { return Body().Get(img); }
    //: Get next frame. 
    //!cwiz:author
  ...
  private:
    ...
    { return dynamic_cast<AudioILibFFmpegBodyC &>(DPIStreamOpC< Int16T, SArray1dC<SampleElemC<2,Int16T> > >::Body()); }
    //: Access body.

    const AudioILibFFmpegBodyC &Body() const
    { return dynamic_cast<const AudioILibFFmpegBodyC &>(DPIStreamOpC< Int16T, SArray1dC<SampleElemC<2,Int16T> > >::Body()); }
    //: Access body.
  };
